...
//Code Here
let totalPopulation = populations.reduce((accumlator, element, index, arr) => {
...
//filter loops for you, return element.cp 
////////// PROBLEM 5 //////////
...
/*
  Use a higher order method to get all the order totals after adding in the sales 
  tax (given to you as a tax rate, hint: you'll need to do some multiplication). 
...
const bobsTotal = purchases.reduce((acc, curr, i, arr) => {
  if(curr.owner === 'Bob'){
